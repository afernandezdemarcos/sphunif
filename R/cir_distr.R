...
#' @rdname cir_stat_distr
#' @export
p_cir_stat_LSE <- function(x, kappa = 1.0, K_max = 1e3, thre = 0, ...) {
  
  p_sph_stat_LSE(x = x, p = 2, kappa = kappa, K_max = K_max, thre = thre, ...)
...
#' @rdname cir_stat_distr
#' @export
d_cir_stat_LSE <- function(x, kappa = 1.0, K_max = 1e3, thre = 0, ...) {
  
  d_sph_stat_LSE(x = x, p = 2, kappa = kappa, K_max = K_max, thre = thre, ...)
