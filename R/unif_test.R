...
unif_test <- function(data, type = "all", p_value = "asymp",
                      ...
                      Pycke_q = 0.5, Riesz_s = 1, LSE_kappa = 1.0, 
                      Poisson_rho = 0.5, CCF09_dirs = NULL, K_CCF09 = 25, 
                      CJ12_reg = 3, CJ12_beta = 0, K_max = 1e4,
                      ...) {
  ...
  stat <- unif_stat(data = data, type = stats_type, data_sorted = data_sorted,
                    ...
                    Pycke_q = Pycke_q, Riesz_s = Riesz_s, LSE_kappa = LSE_kappa, 
    ...
    if (p == 2) {
      ...
      method <- switch(stats_type[i],
         ...
         "Log_gaps" = paste("Darling\'s log-gaps spacings test of",
                            "circular uniformity"),
         "LSE" = "Smooth maximum (LogSumExp) test of circular uniformity",
         ...
         "PCvM" = paste("Projected Cramer-von Mises test of",
                        "circular uniformity"),
         "Poisson_squared" = "Poisson squared test of circular uniformity",
         "Poisson_cosine" = "Poisson cosine test of circular uniformity",
      ...
      alternative <- switch(stats_type[i],
         ...
         "LSE" = "any alternative to circular uniformity",
         ...
         "PRt" = paste("any alternative to circular uniformity",
                       "if t is irrational"),
         "Poisson_squared" = "any alternative to circular uniformity",
         "Poisson_cosine" = "any alternative to circular uniformity",
      ...
      method <- switch(stats_type[i],
         ...
         "LSE" = "Smooth maximum (LogSumExp) test of spherical uniformity",
         "PAD" = paste("Projected Anderson-Darling test of",
                        "spherical uniformity"),
         "PCvM" = paste("Projected Cramer-von Mises test of",
                        "spherical uniformity"),
         "Poisson_squared" = "Poisson squared test of spherical uniformity",
         "Poisson_cosine" = "Poisson cosine test of spherical uniformity",
      ...
      alternative <- switch(stats_type[i],
         ...
         "LSE" = "any alternative to spherical uniformity",
         "PCvM" = "any alternative to spherical uniformity",
         "PAD" = "any alternative to spherical uniformity",
         "Poisson_squared" = "any alternative to spherical uniformity",
         "Poisson_cosine" = "any alternative to spherical uniformity",
