    ...
    if (p == 2) {
      ...
      method <- switch(stats_type[i],
         ...
         "PCvM" = paste("Projected Cramer-von Mises test of",
                        "circular uniformity"),
         "Poisson" = "Poisson kernel-based test of circular uniformity",
      ...
      alternative <- switch(stats_type[i],
         ...
         "PRt" = paste("any alternative to circular uniformity",
                       "if t is irrational"),
         "Poisson" = "any alternative to circular uniformity",
      ...
      method <- switch(stats_type[i],
         ...
         "PCvM" = paste("Projected Cramer-von Mises test of",
                        "spherical uniformity"),
         "Poisson" = "Poisson kernel-based test of spherical uniformity",
      ...
      alternative <- switch(stats_type[i],
         ...
         "Poisson" = "any alternative to spherical uniformity",
